    ...
    <div class="navbar-collapse collapse">
      ...
      <?php endif; ?>
        ...
        <?php else: ?>
          ...
          <?php endif; ?> -->
          <?php if (empty(variable_get_value('access_signup_button_disabled')) || !variable_get_value('access_signup_button_disabled')): ?>
                <li> <a href="user/login"> Administrators </a> </li>
          <?php endif; ?> 
         <li> 
         <!--<?php
          ...
          <a href="https://dev-agate.eucanshare.bsc.es/auth/signin/eush-dev?redirect=https://dev-studies.eucanshare.bsc.es/node&signin_error=https://dev-studies.eucanshare.bsc.es%2Fagate%2Fregister%2F%23%2Fjoin/"> Sign In </a>
          </li>
        <?php endif; ?>
            <!--        Switch lang if enabled-->
