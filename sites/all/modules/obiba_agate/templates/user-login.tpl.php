      ...
      <!--
        <div class="md-top-margin">
          <?php print l(t('Forgot your password?'), 'user/password') ?>
            <div>
              <?php if (empty(variable_get_value('access_signup_button_disabled'
)) || !variable_get_value('access_signup_button_disabled')): ?>
                <?php $register_url = (module_exists('obiba_agate') ? 'agate' : 
'user') . '/register/';
                $option_sign_up = [];
